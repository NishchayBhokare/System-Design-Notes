//Single Responsibility Principle (SRP) state that, class should have only one reason to change.
//This means a class should be responsible for only one specific job.
