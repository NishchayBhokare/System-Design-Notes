//Liskov Substitution Principle (LSP) state that Subclasses should be substitutable for their base classes.
//A child class should be able to replace its parent class without changing the correctness of the program.
//If a subclass cannot behave like its parent, inheritance is probably being used incorrectly.
